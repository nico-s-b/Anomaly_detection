...
def build_unet(input_shape):
    ...
    c1 = Activation('relu')(c1)
    c1 = Conv2D(32, (3, 3), activation='relu', kernel_initializer='he_normal', padding='same')(c1)  # Added extra layer
    c1 = Activation('relu')(c1)
    ...
    c2 = Activation('relu')(c2)
    c2 = Conv2D(64, (3, 3), activation='relu', kernel_initializer='he_normal', padding='same')(c2)  # Added extra layer
    c2 = Activation('relu')(c2)
    ...
    c3 = Activation('relu')(c3)
    c3 = Conv2D(128, (3, 3), activation='relu', kernel_initializer='he_normal', padding='same')(c3)  # Added extra layer
    c3 = Activation('relu')(c3)
    ...
    c4 = Activation('relu')(c4)
    c4 = Conv2D(256, (3, 3), activation='relu', kernel_initializer='he_normal', padding='same')(c4)  # Added extra layer
    c4 = Activation('relu')(c4)
    ...
    c6 = Activation('relu')(c6)
    c6 = Conv2D(256, (3, 3), activation='relu', kernel_initializer='he_normal', padding='same')(c6)  # Added extra layer
    c6 = Activation('relu')(c6)
    ...
    c7 = Activation('relu')(c7)
    c7 = Conv2D(128, (3, 3), activation='relu', kernel_initializer='he_normal', padding='same')(c7)  # Added extra layer
    c7 = Activation('relu')(c7)
    ...
    c8 = Activation('relu')(c8)
    c8 = Conv2D(64, (3, 3), activation='relu', kernel_initializer='he_normal', padding='same')(c8)  # Added extra layer
    c8 = Activation('relu')(c8)
    ...
    c9 = Activation('relu')(c9)
    c9 = Conv2D(32, (3, 3), activation='relu', kernel_initializer='he_normal', padding='same')(c9)  # Added extra layer
    c9 = Activation('relu')(c9)
